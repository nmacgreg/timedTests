...
the number of questions from the 9-times-tables has fallen.  
* I added t3.pl to address this, attempting to select fully one-third of the questions from the sqrt of the highest multiplier.  
* I bumped the minimum to 3, so no more 
2 x 2 or 2 x 8.  It's going to be hard to write code that's generic, this won't work at level 19 and above. 
